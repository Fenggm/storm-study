...
public class MailInfo implements Serializable {
    ...
    public MailInfo(String title, String content, List<String> receiver, List<String> ccList) {
        ...
        this.mailServerHost = MailCenterConstant.getSmtpServer();
        this.userName = MailCenterConstant.getUSER();
        this.userPassword = MailCenterConstant.getPWD();
        this.fromAddress = MailCenterConstant.getFromAddress();
